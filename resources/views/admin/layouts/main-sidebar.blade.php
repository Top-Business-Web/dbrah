...
<aside class="app-sidebar">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ route('providers.index') }}">
                <i class="fe fe-users side-menu__icon"></i>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a href="{{ route('deliveryTimes.index') }}" class="slide-item" style="font-size: 14px">أوقات
                        التوصيل</a></li>
                <li><a href="{{ route('nationalities.index') }}" class="slide-item"
                        style="font-size: 14px">الجنسيات</a></li>
