...
@endsection
@section('page_name') بيانات العميل @endsection
@section('content')
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                    ...
                    <div class="wideget-user text-center">
                        <div class="wideget-user-desc">
                            <div class="wideget-user-img">
                                <img class="" src="{{$user->image}}" alt="img"></div>
                            <div class="user-wrap"><h4 class="mb-1">{{$user->name}}</h4> <h6 class="text-muted mb-4">
                                    وقت الانضمام : {{$user->created_at->diffForHumans()}}</h6>
                                @if($average != 0)
                                    <div class="wideget-user-rating">
                                        <a href="#">
                                            @for($i = 1 ; $i <= 5; $i++)
                                                <i class="fa fa-star {{(round($average) >= $i) ? 'text-warning' : 'text-default'}}"></i>
                                            @endfor
                                        </a>
            ...
            <div class="card">
                ...
                <div class="card-body wideget-user-contact">
                    ...
                    <div class="media mb-0 mt-0">
                        ...
                        <div class="media-body"><a href="tel:{{$user->phone_code.$user->phone}}" class="text-dark">الهاتف</a>
        ...
        <div class="col-lg-8">
                ...
                <div class="wideget-user-tab">
                    <div class="tab-menu-heading">
                        <div class="tabs-menu1">
                            <ul class="nav">
                                <li class=""><a href="#tab-51" class="show active" data-toggle="tab">الطلبات <i class="fa fa-shopping-cart"></i> </a>
                                </li>
                                <li><a href="#tab-61" data-toggle="tab" class="">أحدث موقع <i class="fa fa-map-marked mr-1"></i> </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-content">
                <div class="tab-pane show active" id="tab-51">
                        ...
                        <div class="card-body">
                            <div class="example">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item justify-content-between"> طلبات معلقة <span
                                            class="badgetext badge badge-warning badge-pill">{{($offered_orders) ?? 0}}</span>
                                    </li>
                                    <li class="list-group-item justify-content-between"> طلبات جارية <span
                    ...
                    {{--                    <div class="card">--}}
                    {{--                        <div class="card-body">--}}
                    {{--                            <div class="media-heading"><h5><strong>مستوي الرضي</strong></h5></div>--}}
                    {{--                            <div class="row mt-5">--}}
                    {{--                                <div class="col-md-6"><label>قبول الطلبات</label>--}}
                    {{--                                    <div class="progress progress-md mb-3">--}}
                    {{--                                        <div class="progress-bar  bg-primary w-50">50%</div>--}}
                    {{--                                    </div>--}}
                    {{--                                </div>--}}
                    {{--                                <div class="col-md-6"><label>Wordpress</label>--}}
                    {{--                                    <div class="progress progress-md mb-3">--}}
                    {{--                                        <div class="progress-bar bg-danger w-70">70%</div>--}}
                    {{--                                    </div>--}}
                    {{--                                </div>--}}
                    {{--                                <div class="col-md-6"><label>Javascript</label>--}}
                    {{--                                    <div class="progress progress-md mb-3">--}}
                    {{--                                        <div class="progress-bar  bg-warning w-80">80%</div>--}}
                    {{--                                    </div>--}}
                    {{--                                </div>--}}
                    {{--                                <div class="col-md-6"><label>Photography</label>--}}
                    {{--                                    <div class="progress progress-md mb-3">--}}
                    {{--                                        <div class="progress-bar bg-secondary w-75">75%</div>--}}
                    {{--                                    </div>--}}
                    {{--                                </div>--}}
                    {{--                                <div class="col-md-6"><label>Php</label>--}}
                    {{--                                    <div class="progress progress-md mb-3 mb-md-0">--}}
                    {{--                                        <div class="progress-bar bg-secondary1 w-65">80%</div>--}}
                    {{--                                    </div>--}}
                    {{--                                </div>--}}
                    {{--                                <div class="col-md-6"><label>Android</label>--}}
    ...
    <script>
        function initAutocomplete() {
            var map = new google.maps.Map(document.getElementById('map'), {
                center: {lat: {{$user->addresses->last()->latitude}}, lng: {{$user->addresses->last()->latitude}}},
                zoom: 13,
                mapTypeId: 'roadmap'
            });
