...
@section('title')
    {{($setting->title) ?? ''}} | التصنيفات الرئيسية
@endsection
@section('page_name') التصنيفات الرئيسية @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">قائمة التصنيفات الرئيسية</h3>
                    <div class="">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-20px">العنوان (ar)</th>
                                <th class="min-w-20px">العنوان (en)</th>
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        deleteScript('{{route('category.delete')}}');
        // Add Using Ajax
