...
<form id="addForm" class="addForm" method="POST" enctype="multipart/form-data" action="{{route('deliveryTimes.store')}}">
    ...
    <div class="form-group">
        ...
        <input type="time" class="form-control" name="from" id="start_time"  value="{{$deliveryTime->from}}">
    </div>
    <div class="form-group">
        <label for="to" class="form-control-label">وقت الانتهاء</label>
        <input type="time" class="form-control" name="to" id="end_time" value="{{$deliveryTime->to}}">
